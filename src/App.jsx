      ...
      {window.__ERUDA_ENABLED__ && (
        ...
        >
          ...
          >
            <path
              fill="currentColor"
              d="M14.8 3.4a4.7 4.7 0 0 0-4.6 5.7L3.6 15.7a1.8 1.8 0 0 0 0 2.6l2.1 2.1a1.8 1.8 0 0 0 2.6 0l6.6-6.6a4.7 4.7 0 0 0 5.7-4.6l-2.7 1-2.2-2.2z"
            />
            <path
              fill="currentColor"
              d="M9.2 3.2L7.8 4.6l2 2-2.4 2.4-2-2L4 8.4l2 2-1.6 1.6 2 2L8 12.4l2 2 1.4-1.4-2-2 2.4-2.4 2 2 1.4-1.4z"
              opacity="0.9"
            />
          </svg>
        </button>
